...
import { Shield, Loader2, Newspaper, AlertTriangle, Info, CheckCircle, Search, Filter, Bell, BarChart3 } from "lucide-react";
...
export default function RegulatoryWatch() {
  ...
  const { data: updates, isLoading: updatesLoading } = trpc.regulatory.list.useQuery(
    queryParams,
          ...
          <div className="flex items-center gap-6">
            ...
            <nav className="flex items-center gap-4">
              ...
              <Link href="/regulatory-watch">
                <Button variant="ghost" className="font-medium">Veille</Button>
              </Link>
            </nav>
          </div>
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-2 flex-wrap">
                        ...
                        <Badge className={impactColors[update.impactLevel as keyof typeof impactColors]}>
                          Impact {update.impactLevel === "high" ? "élevé" : update.impactLevel === "medium" ? "moyen" : "faible"}
                        </Badge>
