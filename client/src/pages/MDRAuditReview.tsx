      ...
      <div className="p-6">
        <Card>
          <CardContent className="space-y-3 p-6">
            ...
            <Button variant="secondary" onClick={() => setLocation("/audits")}>Retour</Button>
          </CardContent>
        </Card>
      </div>
    );
      ...
      <div className="no-print sticky top-0 z-20 mb-4 border-b border-slate-200 bg-slate-50/95 pb-3 backdrop-blur">
        <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <Button variant="outline" onClick={() => setLocation("/audits")}><ArrowLeft className="mr-2 h-4 w-4" />Liste audits</Button>
